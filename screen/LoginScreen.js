...
export default function LoginScreen({navigation}) {
  return (
    ...
    <Image source={require("../assets/logothong.png")}
    ...
    <View style={styles.bot}>
      <View>
      <Text style={{marginTop : 41 , color : "white" , fontSize : 20}}>เข้าสู่ระบบด้วย</Text>
      </View>

      {/* Icon */}
      <View style={styles.icon}>
       
      <View style={{ width: 64, height: 64, backgroundColor: "#FFF", borderRadius: 32, justifyContent: 'center', alignItems: 'center' }}>
       <Image source={require("../assets/google.png")} style={{ width: 32, height: 32 }} />
      </View>
      <View style={{ width: 64, height: 64, backgroundColor: "#4267b2", borderRadius: 32, justifyContent: 'center', alignItems: 'center' }}>
       <Image source={require("../assets/facebook.png")} style={{ width: 32, height: 32 }} />
      </View>
      <View style={{ width: 64, height: 64, backgroundColor: "#39cd00", borderRadius: 32, justifyContent: 'center', alignItems: 'center' }}>
       <Image source={require("../assets/line.png")} style={{ width: 32, height: 32 }} />
      </View>
      </View>
